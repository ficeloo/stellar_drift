...
<p align="center">
  <img src="/media/stellar_drift.gif" width="600" alt="Stellar Drift — aperçu du gameplay">
</p>
...
> Nettoyer une vague → Nouvelle vague (plus dense) → Répéter
...
> [!NOTE]
> Le joueur divise sa vitesse de moitié au rythme de $t_½ = ln(2) / 1.2 ≈ 0.578 s$.
...
> [!NOTE]
> Cadence de tir : 0.2 s — Durée de vie du projectile : 1.5 s.
...
> [!NOTE]
> Soit N le niveau actuel, la vague d'astéroïde est composée de N + 3 grands astéroïdes.
...
> [!NOTE]
> Durée de l'invincibilité : 2.0 s.
...
J'ai identifié ces éléments comme non-essentiels au principe du jeu voulu initialement, à savoir un apprentissage d'une architecture ECS et de Bevy.
>_Je me réserve le droit d'apporter de légères modifications si l'envie m'en prend._
